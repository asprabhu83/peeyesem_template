                                        ...
                                        <tr v-for="(item,index) in cart" :key="index">
                                            ...
                                            <td class="product_quantity">
                                                <div class="product_count_one">
                                                    <b-form-spinbutton id="sb-inline" v-model="item.quantity" inline class="border-0"></b-form-spinbutton>
                                                </div>
                                            </td>
                                            <td class="product_total">${{ discountedPrice(item) * item.quantity }}</td>
                                            
                                            <td class="product_remove"><button @click="removeCartItem(index)" class="bg-transparent remove-btn"><i class="far fa-trash-alt"></i></button></td>
        ...
        meta: [
          {
            hid: 'description',
            name: 'description',
            content: 'Cart page - PEEYESEM HYUNDAI'
          }
        ]
      }
    }
