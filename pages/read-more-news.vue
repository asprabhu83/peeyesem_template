...
export default {
    data(){
            ...
            newsAndEvents: [
        {
          ...
          image: "1.jpg",
          description: `
                    <p style="margin:20px 0;color:black;">Digital campaign - #DontBeAnIdler to encourage customers to save fuel and reduce ‘Air pollution’</p>
                    <p style="margin:20px 0;color:black;">New Delhi, June 05, 2019: Hyundai Motor India Ltd., the country’s first Smart Mobility Solutions Company and the largest exporter since inception announced initiatives driving customer focus towards ‘Air Pollution’ and ‘Water Conservation’ on ‘World Environment Day 2019’.</p>
                    <p style="margin:20px 0;color:black;">The Environment Camps across all Hyundai Service Centres will be organized in line with its commitment to sustainable social development and preservation of the environment. The key components of the camp will entail the following benefits:</p>
                    <p style="margin:20px 0;color:black;">Free Emission Check-up for all visiting vehicles Free AC Check-up for clean cabin Air Free Dry Wash PUC check-up at select service centers Customer Education about regular maintenance of vehicles at authorized service centers</p>
                    <p style="margin:20px 0;color:black;">Commenting on the initiatives, Mr.S Punnaivanam, Vice President – Customer Care, Hyundai Motor India said, “Being a socially responsible and caring brand, Hyundai is committed to upholding its promise of creating a significant difference to the Environment. We adopt eco-friendly initiatives across all processes at workshop and dealerships at a Pan India level. A digital campaign- #DontBeAnIdler on air pollution urging customers to switch off the engine, while waiting at traffic signals will be key to drive behavioral change across the masses.”
