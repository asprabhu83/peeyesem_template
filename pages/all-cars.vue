        ...
        <div class="all_cars_sec  flex flex-wrap justify-center mt-5 mx-auto" id="isotope" v-if="categoryIndex !== 0">
            <div class="item_card" v-for="car in this.$store.state.cars" :key="car.id">
                ...
                <div class="item_details" >
                   ...
                   <div class="text-center font-medium mt-1 mb-1">Starting At Rs.<font-awesome-icon icon="rupee-sign"  size="1x" class="text-black mx-2" />{{car.car_price}}<span class="notice_mark">*</span></div>
                </div>
            </div>
        </div>
