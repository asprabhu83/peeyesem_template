                    ...
                    <div class="product_single_one_img">
                        ...
                        <div v-swiper:mySwiper="swiperOption" ref="mySwiper">
                            <div class="swiper-wrapper">
                                ...
                                <inner-image-zoom :src="getImageUrl(product.src)" :id="product.image_id" :zoomSrc="getImageUrl(product.src)"
                                    moveType="drag" className="product-image-zoom"
                                />
                        ...
                        <div class="modal_product_content_one">
                            ...
                            <form id="product_count_form_two">
                                <div class="product_count_one">
                                    <b-form-spinbutton id="sb-inline" min="1" max="100" v-model="quantity" inline class="border-0"></b-form-spinbutton>
                                </div>
                            </form>
        ...
        meta: [
          {
            hid: 'description',
            name: 'description',
            content: 'Shop page - PEEYESEM HYUNDAI'
          }
        ]
      }
    }
