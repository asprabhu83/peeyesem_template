<template>
  <div>
      <div class="fixed_form_sec">
        ...
        <nuxt-link class="text-uppercase font-semibold text-white form2 form_div" to="/service-booking"><font-awesome-icon icon="tools"  size="2x" class="text-white spanner_icon mx-2" /> <div class="sub_form3 sub_form_div">Book a service</div></nuxt-link>
