<template>
  <div>
      <div class="fixed_form_sec">
        ...
        <nuxt-link class="text-uppercase font-semibold text-white form3 form_div" to="/service-booking"><font-awesome-icon icon="tools"  size="2x" class="text-white spanner_icon mx-2" /> <div class="sub_form3 sub_form_div">Book a service</div></nuxt-link>
        ...
        <nuxt-link class="text-uppercase font-semibold text-white form6 form_div" to="/car-service-detailing"><img class="mx-2" :src="require('@/assets/img/bodyshop.png')" alt="img" style="width:32px;"/> <div class="sub_form6 sub_form_div">BodyShop</div></nuxt-link>
